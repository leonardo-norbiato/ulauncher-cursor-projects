...
from cursor_projects.listeners.query import KeywordQueryEventListener
from cursor_projects.listeners.item_enter import ItemEnterEventListener
from cursor_projects.cursor import Client
...
class CursorProjectsExtension(Extension):
    """ Main Extension Class  """

    def __init__(self):
        """ Initializes the extension """
        super(CursorProjectsExtension, self).__init__()
    ...
    def get_projects(self, query: str):
        projects = self.cursor.get_projects(self.preferences)
